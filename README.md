...
ターミナル内では J も含めて Command / Control を交換します。Caps Lock 位置の J は
Control+J として macSKK のひらがなリセットへ届き、物理 Command キーの J は Command+J
として Kitty の F19（Neovim ターミナル切替）へ届きます。
